...
class DistributionSchedule(models.Model):
    ...
    _sql_constraints = [
        ...
        ('monday_time_check1', "CHECK (monday_hour_from <= monday_hour_to)",
         "The monday_hour_to must be greater than the monday_hour_from."),
        ('monday_time_check2', "CHECK (monday_hour_from2 <= monday_hour_to2)",
         "The monday_hour_to2 must be greater than the monday_hour_from2."),
        ('monday_time_check3', "CHECK (monday_hour_to <= monday_hour_from2)",
         "The monday_hour_from2 must be greater than the monday_hour_to."),
        ('tuesday_time_check1', "CHECK (tuesday_hour_from <= tuesday_hour_to)",
         "The tuesday_hour_to must be greater than the tuesday_hour_from."),
        ('tuesday_time_check2', "CHECK (tuesday_hour_from2 <= tuesday_hour_to2)",
         "The tuesday_hour_to2 must be greater than the tuesday_hour_from2."),
        ('tuesday_time_check3', "CHECK (tuesday_hour_to <= tuesday_hour_from2)",
         "The tuesday_hour_from2 must be greater than the tuesday_hour_to."),
        ('wednesday_time_check1', "CHECK (wednesday_hour_from <= wednesday_hour_to)",
         "The wednesday_hour_to must be greater than the wednesday_hour_from."),
        ('wednesday_time_check2', "CHECK (wednesday_hour_from2 <= wednesday_hour_to2)",
         "The wednesday_hour_to2 must be greater than the wednesday_hour_from2."),
        ('wednesday_time_check3', "CHECK (wednesday_hour_to <= wednesday_hour_from2)",
         "The wednesday_hour_from2 must be greater than the wednesday_hour_to."),
        ('thursday_time_check1', "CHECK (thursday_hour_from <= thursday_hour_to)",
         "The thursday_hour_to must be greater than the thursday_hour_from."),
        ('thursday_time_check2', "CHECK (thursday_hour_from2 <= thursday_hour_to2)",
         "The thursday_hour_to2 must be greater than the thursday_hour_from2."),
        ('thursday_time_check3', "CHECK (thursday_hour_to <= thursday_hour_from2)",
         "The thursday_hour_from2 must be greater than the thursday_hour_to."),
        ('friday_time_check1', "CHECK (friday_hour_from <= friday_hour_to)",
         "The friday_hour_to must be greater than the friday_hour_from."),
        ('friday_time_check2', "CHECK (friday_hour_from2 <= friday_hour_to2)",
         "The friday_hour_to2 must be greater than the friday_hour_from2."),
        ('friday_time_check3', "CHECK (friday_hour_to <= friday_hour_from2)",
         "The friday_hour_from2 must be greater than the friday_hour_to."),
        ('saturday_time_check1', "CHECK (saturday_hour_from <= saturday_hour_to)",
         "The saturday_hour_to must be greater than the saturday_hour_from."),
        ('saturday_time_check2', "CHECK (saturday_hour_from2 <= saturday_hour_to2)",
         "The saturday_hour_to2 must be greater than the saturday_hour_from2."),
        ('saturday_time_check3', "CHECK (saturday_hour_to <= saturday_hour_from2)",
         "The saturday_hour_from2 must be greater than the saturday_hour_to."),
        ('sunday_time_check1', "CHECK (sunday_hour_from <= sunday_hour_to)",
         "The sunday_hour_to must be greater than the sunday_hour_from."),
        ('sunday_time_check2', "CHECK (sunday_hour_from2 <= sunday_hour_to2)",
         "The sunday_hour_to2 must be greater than the sunday_hour_from2."),
        ('sunday_time_check3', "CHECK (sunday_hour_to <= sunday_hour_from2)",
         "The sunday_hour_from2 must be greater than the sunday_hour_to."), ]
    ...
    @api.constrains('hour_from', 'hour_to', 'monday_hour_from', 'monday_hour_to', 'monday_hour_from2',
                    'monday_hour_to2', 'tuesday_hour_from', 'tuesday_hour_to', 'tuesday_hour_from2', 'tuesday_hour_to2',
                    'wednesday_hour_from', 'wednesday_hour_to', 'wednesday_hour_from2', 'wednesday_hour_to2',
                    'thursday_hour_from', 'thursday_hour_to', 'thursday_hour_from2', 'thursday_hour_to2',
                    'friday_hour_from', 'friday_hour_to', 'friday_hour_from2', 'friday_hour_to2', 'saturday_hour_from',
                    'saturday_hour_to', 'saturday_hour_from2', 'saturday_hour_to2', 'sunday_hour_from',
                    'sunday_hour_to', 'sunday_hour_from2', 'sunday_hour_to2')
