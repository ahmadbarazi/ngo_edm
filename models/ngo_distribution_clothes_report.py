...
class Report_ngo_distribution_clothes(models.Model):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        sql = """  delete from report_ngo_edm_distribution_clothes_report_view;
                    ...
                    inner join (select count(*) benified_member_count,application_id,distribution_id  from public.ngo_distribution_beneficiary group by application_id, distribution_id ) C 
